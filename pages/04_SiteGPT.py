...
answers_prompt = ChatPromptTemplate.from_template(
    ...
    Then, give a score to the answer between 0 and 5. If the answer answers the user question the score should be high, else it should be low.
...
with st.sidebar:
    st.markdown("Github Code (https://github.com/nyumz/gpt_Assignment)")
